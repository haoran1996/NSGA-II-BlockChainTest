...
public class Service {
    ...
    public static void main(String[] args){
        ...
        HashMap<Integer, List<Chromosome>> rankedFronts = Service.fastNonDominatedSort(parent);
        List<Chromosome> singularFront = rankedFronts.get(1);
    ...
    public static List<ParetoObject> crowdingDistanceAssignment(List<Chromosome> singularFront) {
        ...
        for(IObjectiveFunction objective : objectives) {
             ...
             */
            //2改为1
            for(i = 1; i < end; i++) singlePareto.get(i).setCrowdingDistance(calculateCrowdingDistance(singlePareto,
                                                                                                        i,
                                                                                                        objective,
                                                                                                        maxObjectiveValue,
                                                                                                        minObjectiveValue));
