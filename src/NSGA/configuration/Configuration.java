 ...
 */
package NSGA.configuration;

import NSGA.Interface.IObjectiveFunction;
import NSGA.objectivefunction.BC_gas;
import NSGA.objectivefunction.BC_time;
import NSGA.objectivefunction.BC_uncov;
...
//    }
    ...
    public static void buildObjectives() {
        ...
        newObjectives.add(new BC_gas());
        newObjectives.add(new BC_uncov());
        newObjectives.add(new BC_time());
